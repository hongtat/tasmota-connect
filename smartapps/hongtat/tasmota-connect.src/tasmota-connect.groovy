...
def moduleMap() {
    def customModule = [
        ...
        "1009": [name: "Generic Metering Switch (3ch)", type: "Tasmota Metering Switch", channel: 3],
        ...
        "1014": [name: "Generic Metering Switch (4ch)", type: "Tasmota Metering Switch", channel: 4],

...
metadata {
    definition (name: "Tasmota Virtual 2 Button", namespace: "hongtat", author: "HongTat Tan", ocfDeviceType: "x.com.st.d.remotecontroller", mcdSync: true, vid: "generic-2-button") {
        capability "Button"
        capability "Sensor"
    ...
    preferences {
        section {
            input(title: "Device Settings",
                    ...
                    type: "paragraph",
                    element: "paragraph")
            input(title: "", description: "Tasmota Virtual 2 Button v${driverVersion()}", displayDuringSetup: false, type: "paragraph", element: "paragraph")
        }
    }
